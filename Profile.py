...
class Profile:
    ...
    created within your program for a2. Pay
    close attention to the properties and
    ...
    are set, but contains no conventions to do
    so. You should make sure that your code
